    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
            <b-img src="/logo_greenshow_placeholder.jpg" fluid alt="Green Show Production"></b-img>
        </div>
        <!-- Grid column -->
        ...
        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="https://instagram.com/expotransportevenezuela" class="text-reset" target="_blank">Instagram</a>
          </p>
        </div>
        <!-- Grid column -->
